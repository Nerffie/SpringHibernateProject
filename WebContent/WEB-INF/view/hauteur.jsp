...
<section class="contact py-5" id="contact">
	<div class="container py-lg-3">
		<form:form action="#" method="post" data-aos="fade-up" modelAttribute="hauteur">
			<div class="row">
				<div class="col-md-6 styled-input mt-0">
				<h3>Hauteur sous plafond brute :<br></h3>
					<form:input type="text" name="hspb" placeholder="en centimère" path="hspb"></form:input>>
				
				<div class="col-md-6 styled-input mt-md-0">
				<h3>Gaine :<br></h3>
				<form:input type="text" name="gaine" placeholder="en centimètre" path="gaine"></form:input>
				</div> 
			</div>
			</div>
			<br>
			<div class="row">
				...
				<form:input type="text" name="hfp" placeholder="en centimètre" path="fp"></form:input>
				...
				<span class="erreur">Veuillez vérifier la condition que Faux-plafond>Gaine+5</span>	
				</div>
				
				<div class="col-md-6 styled-input mt-md-0">
				<h3>Epaisseur de revêtement :<br></h3>
				<form:input type="text" name="ep" placeholder="en centimètre" path="epaisseurRev"></form:input>
				</div> 
