...
<section class="contact py-5" id="contact">
	...
	<div class="footer-grid_section text-center" data-aos="zoom-in">
				<div class="mb-3">
					...
					<img alt="Logo" src="${pageContext.request.contextPath}/resources/images/pic3.jpg" height="25%" width="25%"style="padding-left: 5%">
					<img alt="Logo" src="${pageContext.request.contextPath}/resources/images/pic1.jpg" height="25%" width="25%"style="padding-left: 5%">
					<img alt="Logo" src="${pageContext.request.contextPath}/resources/images/pic2.jpg" height="25%" width="25%"style="padding-left: 5%">
				</div>
				</div>
